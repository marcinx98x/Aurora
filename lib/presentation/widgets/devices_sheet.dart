...
/// Spotify-style devices picker: this phone, Cast, DLNA, Aurora Connect.
...
class _DevicesSheetState extends ConsumerState<DevicesSheet> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (!mounted) return;
      ref.read(devicesControllerProvider.notifier).refreshDiscovery();
    });
  }
...
class DevicesChip extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final controlled =
        ref.watch(devicesControllerProvider.select((s) => s.isReceiverControlled));
      ...
      child: Glass(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              controlled ? 'Controlled · ${chip.label}' : 'Devices: ${chip.label}',
